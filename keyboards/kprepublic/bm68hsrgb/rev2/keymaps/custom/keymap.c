...
static uint8_t base_layer = LAYER_BASE; 
      ...
      if (record->tap.count) {
        ...
        if (record->event.pressed) {
          ...
          if (get_highest_layer(layer_state) == LAYER_BASE) {
            // default_layer_set(1UL << 1); // Mac  == layer 2
            layer_move(LAYER_MAC);
          }
          else {
            // default_layer_set(1UL << 0); // Base == layer 1
        ...
        if (record->event.pressed) {
          // key held down event
          base_layer = get_highest_layer(layer_state);
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_65_ansi (
    ...
    KC_CAPS,     KC_A,       KC_S,       KC_D,       KC_F,       KC_G,       KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,     KC_QUOT,          KC_ENT,  TD(TD_PGDN_PGUP),
  ...
  [LAYER_UTIL] = LAYOUT_65_ansi (
    QK_BOOT,     KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,      KC_F11,  KC_F12,  KC_F13,  KC_PSCR,
#if defined(RGBLIGHT_ENABLE)
    XXXXXXX,     RGB_TOG,    RGB_MOD,    RGB_HUI,    RGB_HUD,    RGB_SAI,    RGB_SAD,    RGB_VAI,    RGB_VAD,    RGB_SPI,    RGB_SPD,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  #if defined(RGB_MATRIX_ENABLE)
    XXXXXXX,     MKC_RM_TOG, MKC_RM_MOD, MKC_RM_HUI, MKC_RM_HUD, MKC_RM_SAI, MKC_RM_SAD, MKC_RM_VAI, MKC_RM_VAD, MKC_RM_SPI, MKC_RM_SPD,  XXXXXXX,          XXXXXXX, XXXXXXX,
  #else
    ...
    XXXXXXX,     XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,     XXXXXXX,          XXXXXXX, XXXXXXX,
#endif
    _______,                 KC_VOLU,    KC_VOLD,    KC_MUTE,    XXXXXXX,    XXXXXXX,    NK_TOGG,    XXXXXXX,    XXXXXXX,    XXXXXXX,     XXXXXXX, _______, XXXXXXX, XXXXXXX,
  ...
  [LAYER_SYS] = LAYOUT_65_ansi (
    ...
    XXXXXXX,     _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,     XXXXXXX, XXXXXXX, XXXXXXX, MKC_LISYSRQ,
